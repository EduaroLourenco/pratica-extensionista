            ...
            {tipo === 'associado' ? (
              <>
                ...
                <div className="grid grid-cols-2">
                  <div className="form-group">
                    ...
                    <input type="text" name="bairro_associado" className="input" required onChange={handleChange} />
                  </div>
                  <div className="form-group">
              ...
              <>
                ...
                <div className="grid grid-cols-2">
                  <div className="form-group">
                    <label className="label">Bairro</label>
                    <input type="text" name="bairro_comercio" className="input" required onChange={handleChange} />
                  </div>
                  <div className="form-group">
                    <label className="label">CEP</label>
